...
changeControlDisplay = function(_input){
	objAnalog.visible = controlMode == MODE_ANALOG;
	objAnalog.updateDisplay(_input.factor,analogDeadzone);
	with(objKey) visible = other.controlMode == MODE_KEYBOARD || other.controlMode == MODE_DPAD;	
}
